                  ...
                  <div class="container">
                      <div class="row align-items-center">
                          <div class="col-xl-3 col-lg-3 col-md-4 col-6">
                              ...
                              <div class="logo">
                                  <nuxt-link to="/">
                                      <img class="main-logo2" src="/assets/img/logo.png" data-rjs="2" alt="GrowUPwTech Tech logo">
                                      <img class="sticky-logo" src="/assets/img/logo.png" data-rjs="2" alt="GrowUPwTech Tech logo">
                                  </nuxt-link>
                              </div>
                              <!-- End of Logo -->
                          </div>
                          ...
                          <div class="col-lg-3 col-md-4 col-sm-5 d-md-block d-none">
                              <div class="urgent-call text-right">
                                  <a href="#" class="btn">Get GrowUPwTech Tech</a>
                              </div>
                          </div>
                      </div>
                  </div>
